...
.controller('ViewController', function($scope, $sce, $window, imgDownloadCache){
    ...
    //This allows to clear cache before trying to load images
    imgDownloadCache.onReady(initView);
